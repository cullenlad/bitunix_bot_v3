...
SAFE_KEYS = sorted({
 ...
 "ACCOUNT_USDT","ORDER_NOTIONAL_PCT","MIN_QTY",
 "TREND_FILTER_ENABLED","TREND_EMA_PERIOD","TREND_SLOPE_BP","TREND_MODE",
 "ATR_FILTER_ENABLED","ATR_PERIOD","ATR_MAX_TO_GRIDSTEP","ATR_SOURCE",
...
# keep existing API placeholders for compatibility if you had them
