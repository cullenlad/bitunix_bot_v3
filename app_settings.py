...
<title>Bitunix Bot Settings</title>
<style>
body{font-family:system-ui,-apple-system,Segoe UI,Roboto,sans-serif;margin:20px;max-width:760px}
...
'''
    return render_template_string(template, user=PANEL_USER, pwd=PANEL_PASS, keys=SAFE_KEYS)
